          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                ...
                highest quality for our clients.
              </p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold text-gray-900 mb-2">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our team is made up of talented and dedicated professionals who
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <img
                src="/public/upload/Mario Rivera.png"
                alt="Mario Rivera"
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <img
                src="/public/upload/Michael Rivera.png"
                alt="Michael Rivera"
                className="w-32 h-32 rounded-full mx-auto mb-4 object-cover"
              />
              <h3 className="text-xl font-bold text-gray-900 mb-2">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <img
                src="/public/upload/Maria Sandoval Rivera.png"
                alt="Maria Sandoval Rossi"
                className="w-32 h-32 rounded-full mx-auto mb-4 object-cover"
              />
              <h3 className="text-xl font-bold text-gray-900 mb-2">
                Mario Rossi
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto mb-8">
            ...
            you are passionate about innovation and excellence, we would love to
            hear from you.
          </p>
