...
const Hero = () => {
  ...
  return (
    <section 
  className="relative w-auto min-h- sm:h-[90vh] overflow-hidden bg-cover bg-center flex items-center"
  style={{
    backgroundImage: `url('https://wpl28.realtyna.net/divi/wp-content/uploads/sites/9/2018/06/slider.jpg')`,
